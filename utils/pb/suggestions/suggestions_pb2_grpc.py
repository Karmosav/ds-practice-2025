...
class SuggestionsServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.NotifyCardFraudCheckCompleted = channel.unary_unary(
                '/suggestions.SuggestionsService/NotifyCardFraudCheckCompleted',
...
class SuggestionsServiceServicer(object):
    ...
    def NotifyCardFraudCheckCompleted(self, request, context):
        """fraud service notifies suggestions service that card fraud check completed
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_SuggestionsServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'NotifyCardFraudCheckCompleted': grpc.unary_unary_rpc_method_handler(
                    servicer.NotifyCardFraudCheckCompleted,
...
class SuggestionsService(object):
    ...
    @staticmethod
    def NotifyCardFraudCheckCompleted(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
