...
class OrderExecutorServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetStatus = channel.unary_unary(
                '/executor.OrderExecutorService/GetStatus',
...
def add_OrderExecutorServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetStatus': grpc.unary_unary_rpc_method_handler(
                    servicer.GetStatus,
                    request_deserializer=executor__pb2.GetStatusRequest.FromString,
                    response_serializer=executor__pb2.GetStatusResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'executor.OrderExecutorService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('executor.OrderExecutorService', rpc_method_handlers)
