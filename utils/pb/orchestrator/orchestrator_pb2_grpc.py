...
class OrchestratorServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ReportFailure = channel.unary_unary(
                '/orchestrator.OrchestratorService/ReportFailure',
                request_serializer=orchestrator__pb2.FailureReportRequest.SerializeToString,
...
class OrchestratorServiceServicer(object):
    ...
    def ReportFailure(self, request, context):
        """Any service can report a failure directly to the orchestrator
        """
...
def add_OrchestratorServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ReportFailure': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=orchestrator__pb2.FailureReportRequest.FromString,
...
class OrchestratorService(object):
    ...
    def ReportFailure(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/orchestrator.OrchestratorService/ReportFailure',
            orchestrator__pb2.FailureReportRequest.SerializeToString,
